...
void TensorTest::test()
{
  ...
  Tensor batch { std::vector<NeuronType>(32, 0), {1, 4, 4, 2} };
  ...
  Tensor channel { batch.copyDepth(0, 3, 3) };

  console.log(channel(0, 0, 0, 0), false);
  console.log(", ", false);
  console.log(channel(0, 0, 0, 1));

  // testing: transpose_width_depth (in debugger -> Locals)

  console.log("*** testing: transpose_width_depth");

  Tensor images { std::vector<NeuronType> {
